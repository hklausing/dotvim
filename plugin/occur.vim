...
" Key bind
nnoremap <silent> <unique> <Leader>ft :Occur<CR>        " find selected text in current buffer
nnoremap <silent> <unique> <Leader>fb :Moccur<CR>       " find selected text in all buffers
nnoremap <silent> <unique> <leader>fu :StarOccur<cr>    " find word under cursor in all buffers
